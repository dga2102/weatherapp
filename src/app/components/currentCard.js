...
export default function CurrentCard({ coords }) {
                ...
                <div className="absolute inset-0 flex p-10">
                    <div className="text-white text-5xl font-semibold drop-shadow-lg">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <span className="text-3xl">{coords.name}</span>
                        </div>

                        <div className="absolute bottom-0 left-0 w-full p-5 text-white font-semibold text-5xl">
                            <p>{data.current_weather.temperature}°C</p><br />
                            <p className="text-3xl">{todayCondition}</p><br />
                            <p className="text-3xl">{data.current_weather.windspeed} km/h</p>
                        </div>
                    </div>
                </div>
            </div>
